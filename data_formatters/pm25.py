"""Custom formatting functions for PM2.5 dataset.
...
class PMFormatter(GenericDataFormatter):
    """Defines and formats data for the PM2.5 dataset.
    ...
    def split_data(self, df, L_in, valid_start=840, test_start=1140):
