...
def main(args):
    ...
    if args.window_size is None:
        args.window_size = int(math.sqrt(L_in))
    swformer = SWFormer(**vars(args), **input_names)
    ...
    if args.test:
        ...
        if args.output_attention:
            pass
            # visualize window attention maps
...
if __name__ == '__main__':
    ...
    parser.add_argument('--valid_start', default=1167, type=int)
    parser.add_argument('--test_start', default=1314, type=int)
    ...
    # parser.add_argument('--ffn_hidden_size', default=40 * 4, type=int)
    parser.add_argument('--activation', choices=['gelu', 'elu', 'relu'], default='gelu', type=str)
    parser.add_argument('--dropout', default=0.1, type=float)
    # whether to output attention maps
    parser.add_argument('--output_attention', action='store_true')
    # encoder type
    parser.add_argument('--encoder_type', choices=['canonical', 'window'], default='window')
