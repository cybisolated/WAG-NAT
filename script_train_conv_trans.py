...
from model import ConvTransformer
...
def main(args):
    ...
    conv_trans = ConvTransformer(**vars(args), **input_names)
    ...
    model = PlModelInterface(model=conv_trans, **vars(args))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='conv_trans', type=str)
    ...
    # model params
    parser.add_argument('--d_model', default=40, type=int)
    parser.add_argument('--num_heads', default=2, type=int)
    parser.add_argument('--num_layers', default=1, type=int)
    parser.add_argument('--q_len', default=6, type=int, help='kernel size of conv1d')
    parser.add_argument('--scale_attn', action='store_true', default=True)
    parser.add_argument('--sparse_attn', action='store_true', help='whether to use sparse attention')
    parser.add_argument('--sub_len', default=1, type=int, help='valid only when sparse_attn=True')
